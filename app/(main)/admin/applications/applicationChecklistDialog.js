                  ...
                  {requirements.map((requirement) => (
                    <tr key={requirement.id}>
                      ...
                      <td className="px-4 py-2 w-1/2">
                        {/* Increased width of the remarks textarea */}
                        <Textarea
                          ...
                          className="w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border-gray-300 rounded-md text-lg"
                        />
                      </td>
                    </tr>
                  ))}
